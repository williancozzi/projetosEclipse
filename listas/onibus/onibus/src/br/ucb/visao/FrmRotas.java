...
public class FrmRotas extends JFrame {
	...
	private JComboBox<String> cbUfPartida = new JComboBox<String>(UFS);
	...
	private JComboBox<String> cbUfChegada = new JComboBox<String>(UFS);
	...
	private JLabel lblPosicao = new JLabel("0/0", JLabel.CENTER);
	private JButton btnRemover = new JButton("-");
	private JButton btnEditar = new JButton("E");

	public FrmRotas(Principal controlador) {
		...
		try {
			...
			btnNovo.addActionListener (new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					controlador.adicionarRota(edtCidadePartida.getText(), cbUfPartida.getSelectedItem().toString(), edtCidadeChegada.getText(), cbUfChegada.getSelectedItem().toString());
				}});
